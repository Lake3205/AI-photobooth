...
<template>
  <section class="p-4 sm:p-6 md:p-10 space-y-6 sm:space-y-10">
    ...
    <div class="flex flex-wrap gap-2 sm:gap-3">
      ...
      <button
          :class="activeView === 'comparison' ? 'bg-indigo-500/30 border-indigo-400 text-indigo-100' : 'bg-white/5 border-white/20 text-white/80 hover:bg-white/10'"
          class="px-4 py-2 border rounded-lg transition min-h-[44px]"
    ...
    <AssumptionComparison v-else-if="activeView === 'comparison'" />
